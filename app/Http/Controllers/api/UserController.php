...
class UserController extends Controller
{
    public function register_admin(Request $request)
    {
        ...
        DB::table('users')->insert([
            'name' => $request->name,
            'email' => $request->email, 'email_verified_at' => now(),
            'password' => bcrypt($request->password), 'remember_token' => Str::random(10), 'role' => 'ADMINISTRATOR',
            'plain_token' => '', 
        ]);
    ...
    public function register_terminal(Request $request)
    {
        ...
        return response()->json([
            'token' => $plain_token, 'message' => 'Berhasil'], 200);
    }
